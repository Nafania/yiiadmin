...
class ManageModelController extends YAdminController
{
	...
	if ( Yii::app()->getRequest()->getIsAjaxRequest() ) {
	    $this->renderPartial('list_objects',array(
	...
	public function actionToggle($model_name, $pk, $attribute) {
		$model = $this->module->loadModel($model_name, 'adminToggle')->findByPk($pk);
		$model->scenario = 'adminToggle';
		...
		if ( !$model->save() ) {
			echo CJSON::encode(array(
				'status' => 'error',
				'message' => YiiadminModule::t('При сохранении возникли ошибки: {errors}', array('{errors}' => implode(', ', $model->getErrors()))),
			...
			echo CJSON::encode(array(
				'status' => 'success',
				'message' => YiiadminModule::t('Запись сохранена'),
				'image' => $images[!$model->$attribute],
			));
		}
		Yii::app()->end();
    ...
    public function actionDeleteSelected() {
        ...
        $selectedItems = Yii::app()->getRequest()->getPost('selectedItems', array());
