...
<div class="column span-6 last"> 
    <div class="module actions" id="recent-actions-module"> 
        <h2><?php echo YiiadminModule::t('Последние действия'); ?></h2>
        <div class="module"> 
	    <ul>
	    <?php 
	    foreach ( $Logs AS $Log ) {
		echo '<li class="add-link"><a href="' . $Log->getUrl() . '">' . $Log->getRoute() . '</a><br /><span class="mini quiet">' . Yii::app()->dateFormatter->formatDateTime($Log->getAdded()) . ' ' . $Log->getUserName() . '</span></li>';
	    }
	    ?>
	    </ul>
        </div>
